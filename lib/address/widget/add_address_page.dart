...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  void initState() {
    ...
    getUser();
    // cityController.text =
    //     " ${locationSelectController.currentPlaceMark.value.administrativeArea} ${locationSelectController.currentPlaceMark.value.postalCode}";
  }
  ...
  saveAddressNow(_context) async {
    ...
    String status = await AddressUtil.saveAddress(
        userModel.id, userModel.token, address, street, city, mobile, pin);
    if (status == "true") {
      ...
      GlobalData.showInSnackBar("Failed to Save Address!", _context, Colors.red,
